...
export function LanguagePrompt() {
  const { speechLanguage, languageLabel, setLanguage, t } = useLanguage();
  ...
  const browserLabel = useMemo(() => languageLabel(browserLanguage), [browserLanguage, languageLabel]);
